...
Public Class Dept_wise_sale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Home.Dept_wise_sale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDept_wise_sale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Dept_wise_sale = New Dept_wise_sale()
        rpt.Site = Me.Site
        Return rpt
    End Function
