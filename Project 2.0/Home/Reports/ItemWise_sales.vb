...
Public Class ItemWise_sales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Home.ItemWise_sales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedItemWise_sales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ItemWise_sales = New ItemWise_sales()
        rpt.Site = Me.Site
        Return rpt
    End Function
