...
Public Class Cash_bill1_ENG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Home.Cash_bill1_ENG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCash_bill1_ENG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cash_bill1_ENG = New Cash_bill1_ENG()
        rpt.Site = Me.Site
        Return rpt
    End Function
