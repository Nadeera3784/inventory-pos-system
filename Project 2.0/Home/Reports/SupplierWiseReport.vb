...
Public Class SupplierWiseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Home.SupplierWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSupplierWiseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SupplierWiseReport = New SupplierWiseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
